...
CREATE MATERIALIZED VIEW "v_Service_Accommodations" AS 
  SELECT ct.service_id AS sa_service_id,
    ...
    ct._driver_assistance_available_name AS service_driver_assistance_available,
    ct._folding_wheelchair_accessible_name AS service_folding_wheelchair_accessible,
    ct._lift_equipped_name AS service_lift_equipped,
...
SELECT 
    ...
    ct._developmentally_disabled_name AS service_developmentally_disabled,
    ct._disabled_name AS service_disabled,
    ct._homeless_name AS service_homeless,
    ct._no_trans_name AS service_no_trans
...
CREATE MATERIALIZED VIEW "v_Service_Trip_Purposes" AS 
  SELECT ct.service_id AS stp_service_id,
    ct._cancer_name AS service_cancer,
    ct._general_name AS service_general,
    ct._grocery_name AS service_grocery,
    ct._leisure_name AS service_leisure,
    ct._medical_name AS service_medical,
    ct._senior_name AS service_senior,
    ct._travel_to_family_member_name AS service_travel_to_family_member,
    ct._travel_to_meal_name AS service_travel_to_meal,
    ct._visit_social_service_agency_name AS service_visit_social_service_agency
  FROM crosstab('SELECT service_trip_purpose_maps.service_id, trip_purposes.name, true as value FROM public.service_trip_purpose_maps, public.trip_purposes WHERE trip_purposes.id = service_trip_purpose_maps.trip_purpose_id ORDER BY 1,2'::text, 
                $$VALUES ('cancer_name'),('general_name'),('grocery_name'),('leisure_name'),('medical_name'),('senior_name'),('travel_to_family_member_name'),('travel_to_meal_name'),('visit_social_service_agency_name') $$) 
  ct (service_id integer,
      _cancer_name boolean,
      _general_name boolean,
      _grocery_name boolean,
      _leisure_name boolean,
      _medical_name boolean,
      _senior_name boolean,
      _travel_to_family_member_name boolean,
      _travel_to_meal_name boolean,
      _visit_social_service_agency_name boolean )
WITH DATA;
...
CREATE MATERIALIZED VIEW "v_Users_Accommodations" AS 
  SELECT ct.user_profile_id AS ua_user_id,
    ...
    ct._driver_assistance_available_name AS user_driver_assistance_available,
    ct._folding_wheelchair_accessible_name AS user_folding_wheelchair_accessible,
    ct._lift_equipped_name AS user_lift_equipped,
...
CREATE MATERIALIZED VIEW "v_Users_Characteristics" AS 
  SELECT ct.user_profile_id AS uc_user_id,
    ...
    ct._developmentally_disabled_name AS user_developmentally_disabled,
    ct._disabled_name AS user_disabled,
    ct._homeless_name AS user_homeless,
    ct._no_trans_name AS user_no_trans
