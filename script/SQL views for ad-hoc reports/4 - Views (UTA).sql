...
CREATE MATERIALIZED VIEW "v_Service_Trip_Purposes" AS 
  SELECT ct.service_id AS stp_service_id,
    ...
    ct._dental_purpose_name AS service_dental_purpose,
    ct._dialysis_purpose_name AS service_dialysis_purpose,
    ...
    ct._hair_purpose_name AS service_hair_purpose,
    ct._pharmacy_purpose_name AS service_pharmacy_purpose,
    ct._senior_center_purpose_name AS service_senior_center_purpose,
    ct._therapy_purpose_name AS service_therapy_purpose,
    ct._visit_spouse_purpose_name AS service_visit_spouse_purpose
