...
CREATE MATERIALIZED VIEW "v_Service_Accommodations" AS 
  SELECT ct.service_id AS sa_service_id,
    ct._companion_allowed_name AS service_companion_allowed,
    ...
    ct._stretcher_accessible_name AS service_stretcher_accessible
...
SELECT 
    ...
    ct._low_income_name AS service_low_income,
    ct._nemt_eligible_name AS service_nemt_eligible,
    ct._no_trans_name AS service_no_trans,
    ct._veteran_name AS service_veteran,
    ct._walk_distance_name AS service_walk_distance
...
CREATE MATERIALIZED VIEW "v_Service_Trip_Purposes" AS 
  SELECT ct.service_id AS stp_service_id,
    ...
    ct._dialysis_name AS service_dialysis,
    ct._general_name AS service_general,
    ct._grocery_name AS service_grocery,
    ct._medical_name AS service_medical,
    ct._personal_name AS service_personal,
    ct._senior_name AS service_senior,
    ct._training_name AS service_training,
    ct._work_name AS service_work
...
CREATE MATERIALIZED VIEW "v_Trips_Desired_Modes" AS 
  SELECT trip_id AS tdm_trip_id,
    ...
    not _mode_rideshare_name is null as trip_desired_mode_rideshare,
...
CREATE MATERIALIZED VIEW "v_Users_Characteristics" AS 
  SELECT ct.user_profile_id AS uc_user_id,
    cast(ct._ada_eligible_name AS boolean) AS user_ada_eligible,
    cast(ct._age_name AS integer) AS user_age,
    ct._date_of_birth_name AS user_date_of_birth,
    cast(ct._disabled_name AS boolean) AS user_disabled,
    cast(ct._low_income_name AS boolean) AS user_low_income,
    cast(ct._nemt_eligible_name AS boolean) AS user_nemt_eligible,
    cast(ct._no_trans_name AS boolean) AS user_no_trans,
    cast(ct._veteran_name AS boolean) AS user_veteran,
    cast(ct._walk_distance_name AS boolean) AS user_walk_distance
...
CREATE MATERIALIZED VIEW "v_Users_Desired_Modes" AS 
  SELECT ct.user_id AS udm_user_id,
    ...
    ct._mode_rideshare_name AS user_desired_mode_rideshare,
