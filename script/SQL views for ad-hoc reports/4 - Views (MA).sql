...
SELECT 
    ...
    ct._disabled_non_elderly_name AS service_disabled_non_elderly,
    ...
    ct._wheelchair_dependent_name AS service_wheelchair_dependent
...
CREATE MATERIALIZED VIEW "v_Service_Trip_Purposes" AS 
  SELECT ct.service_id AS stp_service_id,
    ...
    ct._general_purpose_name AS service_general_purpose,
...
CREATE MATERIALIZED VIEW "v_Users_Accommodations" AS 
  SELECT ct.user_profile_id AS ua_user_id,
    ...
    ct._door_through_door_name AS user_door_through_door,
    ct._door_to_door_name AS user_door_to_door,
    ct._driver_assistance_name AS user_driver_driver_assistance,
...
CREATE MATERIALIZED VIEW "v_Users_Characteristics" AS 
  SELECT ct.user_profile_id AS uc_user_id,
    ...
    ct._disabled_non_elderly_name AS user_disabled_non_elderly,
    ct._nemt_eligible_name AS user_nemt_eligible,
    ct._physically_disabled_name AS user_physically_disabled,
    ct._veteran_name AS user_veteran,
    ct._wheelchair_dependent_name AS user_wheelchair_dependent
