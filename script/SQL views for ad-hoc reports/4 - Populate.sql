...
INSERT INTO reporting_lookup_tables(id, name, display_field_name, created_at, updated_at, id_field_name, data_access_type)
    VALUES (9,'v_Boolean','_en','2015-01-01 00:00:00','2015-01-01 00:00:00','id','');
INSERT INTO reporting_lookup_tables(id, name, display_field_name, created_at, updated_at, id_field_name, data_access_type)
    VALUES (10,'agencies','name','2015-01-01 00:00:00','2015-01-01 00:00:00','id','agency');



INSERT INTO reporting_reports(id, name, description, data_source, created_at, updated_at, is_sys_admin, is_provider_staff, is_agency_admin, is_agent)
    VALUES (1,'Services','Defined Services','v_Services','2015-01-01 00:00:00','2015-01-01 00:00:00',TRUE,TRUE,FALSE,FALSE);
INSERT INTO reporting_reports(id, name, description, data_source, created_at, updated_at, is_sys_admin, is_provider_staff, is_agency_admin, is_agent)
    VALUES (2,'Users','All Users','v_Users','2015-04-13 19:43:49.036979','2015-04-13 20:21:41.785259',TRUE,FALSE,FALSE,FALSE);
INSERT INTO reporting_reports(id, name, description, data_source, created_at, updated_at, is_sys_admin, is_provider_staff, is_agency_admin, is_agent)
    VALUES (3,'Trip-Travelers','Trip Travelers','v_Trips_Users','2015-01-01 00:00:00','2015-04-15 16:15:21.475268',TRUE,FALSE,TRUE,TRUE);
INSERT INTO reporting_reports(id, name, description, data_source, created_at, updated_at, is_sys_admin, is_provider_staff, is_agency_admin, is_agent)
    VALUES (4,'Itineraries-Travelers','Itineraries displayed to Travelers ','v_Itineraries_Users','2015-01-01 00:00:00','2015-01-01 00:00:00',TRUE,TRUE,TRUE,TRUE);
INSERT INTO reporting_reports(id, name, description, data_source, created_at, updated_at, is_sys_admin, is_provider_staff, is_agency_admin, is_agent)
    VALUES (5,'Trip Parts-Travelers','Trip Parts Travelers','v_Trip_Parts_Users','2015-01-01 00:00:00','2015-01-01 00:00:00',TRUE,FALSE,TRUE,TRUE);
...
INSERT INTO reporting_filter_fields(id, reporting_filter_group_id, reporting_filter_type_id, reporting_lookup_table_id, name, title, created_at, updated_at, sort_order, value_type)
    VALUES (29,1,30,9,'active','Is Active?','2015-01-01 00:00:00','2015-01-01 00:00:00',4,'');
