...
CREATE MATERIALIZED VIEW "v_Service_Accommodations" AS 
  SELECT ct.service_id AS "SA_ID",
    ...
    ct._motorized_wheelchair_accessible_name AS "service_stretcher_name",
    ct._stretcher_name AS "service_wheelchair_lift_equipped_name"
...
CREATE MATERIALIZED VIEW "v_Users_Accommodations" AS 
  SELECT ct.user_profile_id AS "UA_ID",
    ...
    ct._motorized_wheelchair_accessible_name AS "user_stretcher_name",
    ct._stretcher_name AS "user_wheelchair_lift_equipped_name"
...
CREATE MATERIALIZED VIEW "v_Users_Characteristics" AS 
  SELECT ct.user_profile_id AS "UC_ID",
    ...
    ct._medicaid_name AS "user_medicaid_name",
