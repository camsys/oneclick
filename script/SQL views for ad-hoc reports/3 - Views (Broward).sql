...
CREATE MATERIALIZED VIEW "v_Service_Trip_Purposes" AS 
  SELECT ct.service_id AS "STP_ID",
    ...
    ct._leisure_name AS "service_leisure_name",
    ct._medical_name AS "service_medical_name",
    ct._senior_name AS "service_senior_name",
    ct._travel_to_family_member_name AS "service_travel_to_family_member_name",
    ct._travel_to_meal_name AS "service_travel_to_meal_name",
    ct._visit_social_service_agency_name AS "service_visit_social_service_agency_name"
...
CREATE MATERIALIZED VIEW "v_Users_Accommodations" AS 
  SELECT ct.user_profile_id AS "UA_ID",
    ...
    ct._driver_assistance_available_name AS "user_driver_assistance_available_name",
    ct._folding_wheelchair_accessible_name AS "user_folding_wheelchair_accessible_name",
    ct._lift_equipped_name AS "user_lift_equipped_name",
...
CREATE MATERIALIZED VIEW "v_Users_Characteristics" AS 
  SELECT ct.user_profile_id AS "UC_ID",
    ...
    ct._homeless_name AS "user_homeless_name",
    ct._no_trans_name AS "user_no_trans_name"
