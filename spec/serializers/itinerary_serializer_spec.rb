...
RESULT = [
  {:type=>"BUS",
   :description=>"Bus Route 110 - Five Points To PEACHTREE ST NW@INTERNATIONAL BLVD",
  ...
  {:type=>"BUS",
   :description=>"Bus Route 112 - Someplace Else To PEACHTREE ST NW@INTERNATIONAL BLVD",
   :start_time=>'2013-12-09T18:17:20-05:00',
   :end_time=>'2013-12-09T18:27:20-05:00',
   :start_place=>"33.774944,-84.384911",
   :end_place=>"33.759853,-84.387728"},
  {:type=>"BUS",
   :description=>"Bus Route 113 - Yet Another Place To PEACHTREE ST NW@INTERNATIONAL BLVD",
