...
CsLeaflet.SidewalkFeedbackTool = {
    ...
    getFormattedFeedbackInputFormForMarker: function(lat, lng) {
        ...
        return "<div class='well'>" +
            ...
            "<button class='btn map-action-button' action='submit' style='margin-right: 5px;'>" + locale_text.submit + "</button>" +
    ...
    getPopupTextForExistingFeedback: function(feedbackData, allowActions) {
    	...
    	return "<div class='well'>" +
            ...
            (
                ...
                (
                    "<button class='btn map-action-button' action='approve' style='margin-right: 5px;'>" + locale_text.approve + "</button>" + 
                    "<button class='btn map-action-button' action='reject' style='margin-right: 5px;'>" + locale_text.reject + "</button>"
                ) : ""
            ) +
            (allowActions.is_deletable ? "<button class='btn map-action-button' action='delete' style='margin-right: 5px;'>" + locale_text.delete + "</button>": "") +
            "</div></div>" +
            "<div class='row'>" + 
