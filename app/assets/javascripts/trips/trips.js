    ...
    if (document.readyState === "complete") {
      switch(tripformView.indexCounter) {
        ...
        case 7:
          ...
          $('#left-description p').html("Choose the time you will be leaving your destination location, to return back to your starting location. A time 2 hours in the future has already been selected for you.<br><br>Tap \'Next Step\' when you have selected the correct time to leave your destination.");
