...
Translation.create(:key => 'traveler_revoke_email', locale: :en, complete: true, value: text)
text="Your traveler has declined their status"
Translation.create(:key => 'traveler_decline_email', locale: :en, complete: true, value: text)
text="Your traveler has confirmed your status"
Translation.create(:key => 'traveler_confirm_email', locale: :en, complete: true, value: text)
text="Your buddy has revoked their status"
Translation.create(:key => 'buddy_revoke_email', locale: :en, complete: true, value: text)
text="A traveler has request that you help them plan trips."
Translation.create(:key => 'buddy_request_email', locale: :en, complete: true, value: text)
